...
export const CHANGELOG: Release[] = [
  {
    version: "1.5.4",
    date: "1 กรกฎาคม 2569",
    title: "เปิดรับรูปชั่วคราว: เลือกรอบได้ · มอบหมายงานให้ตรงรอบที่เปิด",
    changes: [
      {
        type: "fix",
        text: "[Web] แก้อาการ 'มอบหมายงานแล้วสินค้าไม่ขึ้นให้นับในแอป' ช่วงวันตัดรอบ (วันที่ 1/16) — ปุ่มมอบหมายทุกสินค้าและหน้าสินค้า จะมอบงานเข้ารอบที่ 'เปิดรับรูปชั่วคราว' อยู่ แทนรอบปัจจุบันตามวันที่",
        before:
          "วันตัดรอบ ระบบมอบงานเข้ารอบใหม่เสมอ แต่แอปดึงงานของรอบที่เปิด override มาแสดง เดือน/รอบไม่ตรง สินค้าจึงไม่ขึ้น (เป็นทุก Role)",
        after:
          "เมื่อเปิดรับรูปชั่วคราวอยู่ งานที่มอบหมายจะผูกกับรอบที่เปิดไว้ และแสดงในแอปพร้อมป้าย 'ส่งล่าช้า'",
      },
      {
        type: "feature",
        text: "[Web] หน้า Counting Periods: เพิ่มตัวเลือก 'เลือกรอบที่จะเปิดรับ (ส่งล่าช้า)' ในเมนูเปิดรับรูปชั่วคราว — เลือกรอบย้อนหลังได้เอง (เช่น 2–15 หรือ 17–สิ้นเดือน) ให้ตรงกับรอบที่พนักงานมีงานค้าง",
        before:
          "เดิมเปิดรับรูปชั่วคราวจะผูกกับรอบล่าสุดที่จบแล้วเสมอ เลือกรอบเองไม่ได้",
        after: "ผู้จัดการเลือกได้ว่าจะเปิดรับรูปของรอบไหน (ค่าเริ่มต้น = รอบล่าสุด)",
      },
    ],
  },
  {
