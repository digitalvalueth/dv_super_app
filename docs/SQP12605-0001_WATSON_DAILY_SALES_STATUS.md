...
**ยังเหลือ:**
- ทดสอบ **พฤติกรรม end-to-end จริงบนอุปกรณ์/เว็บ** (unit test ครอบ logic แล้ว แต่ยังไม่ได้รันแอปจริงกับข้อมูล Phithan — ต้อง login) · กำลัง setup Cypress E2E

> ครบทุกฟีเจอร์ในใบเสนอราคา (1–5) + บัค P0/P1/P2 ทั้งหมดแล้ว — เหลือเฉพาะการทดสอบ E2E จริง
...
- [x] ~~ยืนยันกับลูกค้าเรื่อง "โปรหลายสินค้า" (2e)~~ → **ลูกค้ายืนยัน = แบบเดิม (มีโปรหลายตัวพร้อมกัน)** = เสร็จแล้ว ไม่ต้องทำเพิ่ม ✅
- [x] เพิ่ม validate ช่วงวันที่โปรซ้อนทับในหน้าหลังบ้าน *(บัค #8)* — block save + error ระบุสินค้า/ช่วงที่ชน + 20 unit tests ✅
